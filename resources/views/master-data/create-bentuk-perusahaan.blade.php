...
@section('title', 'Tambah Bentuk Perusahaan')
    ...
    <div class="container mt-4">
        <div class="card shadow">
            <div class="card-header bg-primary text-white">
                <h3 class="mb-0"><i class="fas fa-building mr-2"></i>Tambah Bentuk Perusahaan</h3>
            </div>
            <div class="card-body">
                <form action="{{ route('bentuk-perusahaan.store') }}" method="POST" class="needs-validation" novalidate>
                    @csrf
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="bentuk_perusahaan" id="bentuk_perusahaan" class="form-control" required>
                        </div>
                    </div>
