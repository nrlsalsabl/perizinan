    ...
    <div class="container mt-4">
        <div class="card shadow">
            <div class="card-header bg-primary text-white">
                <h3 class="mb-0"><i class="fas fa-user-edit mr-2"></i>Edit Data Kadis</h3>
            </div>
            <div class="card-body">
                <form action="{{ route('kelola-data-kadis.update', $kadis->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" name="nip" class="form-control" value="{{ $kadis->nip }}" id="nip" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="nama" class="form-control" value="{{ $kadis->nama }}" id="nama" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="pangkat" class="form-control" value="{{ $kadis->pangkat }}" id="pangkat" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="periode" id="periode" class="form-control date" value="{{ $kadis->periode }}" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <select name="status" class="form-control" id="status">
                                <option value="Aktif" {{ $kadis->status == 'Aktif' ? 'selected' : '' }}>Aktif</option>
                                <option value="Tidak Aktif" {{ $kadis->status == 'Tidak Aktif' ? 'selected' : '' }}>Tidak Aktif</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        @if($kadis->ttd)
                            <div class="mt-2">
                                <p class="mb-1">TTD Saat Ini:</p>
                                <img src="{{ asset('storage/Aktif/' . $kadis->ttd) }}" alt="Current TTD" class="preview-image">
                            </div>
                        @endif
