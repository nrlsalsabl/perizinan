    ...
    <div class="container mt-4">
        <div class="card shadow">
            <div class="card-header bg-primary text-white">
                <h3 class="mb-0"><i class="fas fa-map-marker-alt mr-2"></i>Daftar Kecamatan</h3>
            </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between mb-4">
                    ...
                    <form action="{{ route('kecamatan.index') }}" method="GET" class="w-50">
                        ...
                        <tbody>
                            @foreach ($kecamatans as $kecamatan)
                                <tr>
                                    ...
                                    <td>{{ $kecamatan->kabupaten_kota }}</td>
