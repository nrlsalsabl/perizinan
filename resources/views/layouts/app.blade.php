    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            collapseBtn.addEventListener('click', function(e) {
                ...
                if (collapsed) {
                    collapseIcon.classList.remove('zmdi-chevron-left');
                    collapseIcon.classList.add('zmdi-chevron-right');
                } else {
                    collapseIcon.classList.remove('zmdi-chevron-right');
                    collapseIcon.classList.add('zmdi-chevron-left');
                }
            });

            // Toggle dropdown menus in sidebar (for click, not hover)
            document.querySelectorAll('#sidebar .nav-link.dropdown-toggle').forEach(link => {
                link.addEventListener('click', function(e) {
                    e.preventDefault();
                    // Only toggle if sidebar is not collapsed (hover handles collapsed)
