...
@section('content')
    <div class="container">
        <form action="{{ route('verifikasi-kasi.update', $pendaftaran->id) }}" method="POST">
            @csrf
            ...
            <div class="card">
                ...
                <div class="p-4">
                    <div class="col form-group">
                        ...
                        <a href="{{ Storage::url($lampiran->surat_permohonan) }}" class="btn btn-primary preview-btn" target="_blank">preview</a>
                    </div>
                    <div class="col form-group">
                        ...
                        <a href="{{ Storage::url($lampiran->ktp_dir) }}" class="btn btn-primary preview-btn" target="_blank">preview</a>
                    </div>
                    <div class="col form-group">
                        ...
                        <a href="{{ Storage::url($lampiran->nib_oss) }}" class="btn btn-primary preview-btn" target="_blank">preview</a>
                    </div>
                    <div class="col form-group">
                        ...
                        <a href="{{ Storage::url($lampiran->izin_usaha) }}" class="btn btn-primary preview-btn" target="_blank">preview</a>
                    </div>
                    <div class="col form-group">
                        ...
                        <a href="{{ Storage::url($lampiran->akta_per) }}" class="btn btn-primary preview-btn" target="_blank">preview</a>
                    </div>
                    <div class="col form-group">
                        ...
                        <a href="{{ Storage::url($lampiran->profil_per) }}" class="btn btn-primary preview-btn" target="_blank">preview</a>
                    </div>
                    <div class="col form-group">
                        ...
                        <a href="{{ Storage::url($lampiran->npwp_kaltim) }}" class="btn btn-primary preview-btn" target="_blank">preview</a>
                    </div>
                    <div class="col form-group">
                        ...
                        <a href="{{ Storage::url($lampiran->surat_domisili) }}" class="btn btn-primary preview-btn" target="_blank">preview</a>
                    </div>
                    <div class="col form-group">
                        ...
                        <a href="{{ Storage::url($lampiran->sertif_badan) }}" class="btn btn-primary preview-btn" target="_blank">preview</a>
                    </div>
                    <div class="col form-group">
                        ...
                        <a href="{{ Storage::url($lampiran->rencana_peng) }}" class="btn btn-primary preview-btn" target="_blank">preview</a>
                    </div>
                    <div class="col form-group">
                        ...
                        <a href="{{ Storage::url($lampiran->surat_pene) }}" class="btn btn-primary preview-btn" target="_blank">preview</a>
                    </div>
                    <div class="col form-group">
                        ...
                        <a href="{{ Storage::url($lampiran->sertif_kompeten) }}" class="btn btn-primary preview-btn" target="_blank">preview</a>
                    </div>
                    <div class="col form-group">
                        ...
                        <a href="{{ Storage::url($lampiran->sertif_iso) }}" class="btn btn-primary preview-btn" target="_blank">preview</a>
                    </div>
                    <div class="col form-group">
                        ...
                        <a href="{{ Storage::url($lampiran->sop) }}" class="btn btn-primary preview-btn" target="_blank">preview</a>
                    </div>
                    <div class="col form-group">
                        ...
                        <a href="{{ Storage::url($lampiran->peralatan_sewa) }}" class="btn btn-primary preview-btn" target="_blank">preview</a>
                    </div>
                    <div class="col form-group">
                        ...
                        <a href="{{ Storage::url($lampiran->surat_kuasa) }}" class="btn btn-primary preview-btn" target="_blank">preview</a>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="p-4">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="catatan_umum[]" id="catatan_umum" placeholder="Masukkan catatan umum...">
                    </div>
