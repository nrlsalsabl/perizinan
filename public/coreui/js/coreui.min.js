...
!(function (t, e) {
    ...
    class It extends W {
        ...
        _setActiveIndicatorElement(t) {
            ...
            const e = R.findOne(kt, this._indicatorsElement);
    ...
    j.on(
        ...
        function (t) {
            ...
            t.preventDefault();
            const i = It.getOrCreateInstance(e),
        ...
        j.on(window, At, () => {
            ...
            for (const e of t) It.getOrCreateInstance(e);
        }),
        b(It);
    const Dt = ".coreui.collapse",
        xt = `show${Dt}`,
        Mt = `shown${Dt}`,
        Pt = `hide${Dt}`,
        jt = `hidden${Dt}`,
        Ft = `click${Dt}.data-api`,
        zt = "show",
        Ht = "collapse",
        qt = "collapsing",
        Bt = `:scope .${Ht} .${Ht}`,
        Wt = '[data-coreui-toggle="collapse"]',
    ...
    class Kt extends W {
        ...
        _getFirstLevelChildren(t) {
            const e = R.find(Bt, this._config.parent);
    ...
    const Qt = "dropdown",
        ...
        ne = `keyup${Ut}${Yt}`,
        oe = "show",
        re = '[data-coreui-toggle="dropdown"]:not(.disabled):not(:disabled)',
        ae = `${re}.${oe}`,
        le = ".dropdown-menu",
    ...
    class pe extends W {
        constructor(t, e) {
            super(t, e),
                ...
                (this._menu =
                    R.next(this._element, le)[0] ||
                    R.prev(this._element, le)[0] ||
                    R.findOne(le, this._parent)),
        ...
        static dataApiKeydownHandler(t) {
            ...
            const n = this.matches(re)
                    ...
                    : R.prev(this, re)[0] ||
                      R.next(this, re)[0] ||
                      R.findOne(re, t.delegateTarget.parentNode),
    ...
    class Oe extends B {
        ...
        _handleFocusin(t) {
            ...
            0 === i.length
                ? e.focus()
                : this._lastTabNavDirection === Le
                ? i[i.length - 1].focus()
                : i[0].focus();
        }
        _handleKeydown(t) {
            "Tab" === t.key &&
                (this._lastTabNavDirection = t.shiftKey ? Le : "forward");
        }
    }
    ...
    class Me {
        ...
        hide() {
            ...
            this._disableOverFlow(),
                ...
                this._setElementAttributes(Ne, De, (e) => e + t),
                this._setElementAttributes(Ie, xe, (e) => e - t);
        }
        reset() {
            this._resetElementAttributes(this._element, "overflow"),
                this._resetElementAttributes(this._element, De),
                this._resetElementAttributes(Ne, De),
                this._resetElementAttributes(Ie, xe);
        }
        isOverflowing() {
    ...
    const Pe = ".coreui.modal",
        ...
        Be = `resize${Pe}`,
        We = `click.dismiss${Pe}`,
        Ve = `mousedown.dismiss${Pe}`,
        Re = `keydown.dismiss${Pe}`,
        Ke = `click${Pe}.data-api`,
        Qe = "modal-open",
        Ue = "show",
        Ye = "modal-static",
    ...
    j.on(document, Ke, '[data-coreui-toggle="modal"]', function (t) {
        const e = R.getElementFromSelector(this);
        ...
        K(Je),
        b(Je);
    const Ze = "coreui.navigation",
        ti = `.${Ze}`,
        ei = ".data-api",
        ii = { activeLinksExact: !0, groupsAutoCollapse: !0 },
        si = {
    ...
    class ui extends W {
        ...
        _setActiveLink() {
            for (const t of Array.from(
                ...
                if (t.classList.contains(ri)) continue;
                ...
                (/\?.*=/.test(e) || i.test(e)) && (e = e.split("?")[0]),
                    ...
                    this._config.activeLinksExact &&
                        t.href === e &&
                        (t.classList.add(ni),
                        Array.from(this._getParents(t, ci)).forEach((t) => {
                            t.classList.add(oi),
        ...
        _toggleGroupItems(t) {
            let e = t.target;
            e.classList.contains(ri) || (e = e.closest(di));
            const i = (t) =>
                Boolean(
                    t.classList.contains("nav-group") &&
                        t.classList.contains(oi)
                );
            if (!0 === this._config.groupsAutoCollapse)
                for (const t of this._getSiblings(e.parentNode, i))
                    this._slideUp(R.findOne(hi, t), () => {
                        t.classList.remove(oi),
                            t.setAttribute("aria-expanded", !1);
                    });
            e.parentNode.classList.contains(oi)
                ? this._slideUp(R.findOne(hi, e.parentNode), () => {
                      e.parentNode.classList.remove(oi),
                          e.parentNode.setAttribute("aria-expanded", !1);
                  })
                : (e.parentNode.classList.add(oi),
                  e.parentNode.setAttribute("aria-expanded", !0),
                  this._slideDown(R.findOne(hi, e.parentNode)));
        }
        _addEventListeners() {
            j.on(this._element, ai, di, (t) => {
                t.preventDefault(), this._toggleGroupItems(t, this);
            });
        }
        static navigationInterface(t, e) {
            const i = ui.getOrCreateInstance(t, e);
            if ("string" == typeof e) {
                if (void 0 === i[e])
    ...
    j.on(window, li, () => {
        for (const t of Array.from(
            ...
            ui.navigationInterface(t);
    }),
        b(ui);
    const _i = ".coreui.offcanvas",
        gi = ".data-api",
        fi = `load${_i}${gi}`,
        mi = "show",
        pi = "showing",
    ...
    class Oi extends W {
        ...
        show(t) {
            this._isShown ||
                j.trigger(this._element, yi, { relatedTarget: t })
                    .defaultPrevented ||
                ((this._isShown = !0),
                this._backdrop.show(),
        ...
        hide() {
            this._isShown &&
                (j.trigger(this._element, Ai).defaultPrevented ||
                    (this._focustrap.deactivate(),
                    this._element.blur(),
                    (this._isShown = !1),
                    ...
                    this._queueCallback(
                        () => {
                            this._element.classList.remove(mi, bi),
                                this._element.removeAttribute("aria-modal"),
                                this._element.removeAttribute("role"),
    ...
    j.on(document, ki, '[data-coreui-toggle="offcanvas"]', function (t) {
        const e = R.getElementFromSelector(this);
        if (
            (["A", "AREA"].includes(this.tagName) && t.preventDefault(),
            d(this))
        ...
        const i = R.findOne(vi);
        i && i !== e && Oi.getInstance(i).hide(),
            Oi.getOrCreateInstance(e).toggle(this);
    }),
        j.on(window, fi, () => {
            for (const t of R.find(vi)) Oi.getOrCreateInstance(t).show();
        }),
        j.on(window, Ti, () => {
    ...
    const Ni = {
        ...
        xi = (t, e) => {
            ...
            return e.includes(i)
                ? !Ii.has(i) || Boolean(Di.test(t.nodeValue))
                ...
                ? (function (t, e, i) {
                      ...
                      for (const t of n) {
                          ...
                          const s = [].concat(...t.attributes),
                              n = [].concat(e["*"] || [], e[i] || []);
                          for (const e of s)
                              xi(e, n) || t.removeAttribute(e.nodeName);
                      }
    ...
    class Xi extends W {
        ...
        dispose() {
            clearTimeout(this._timeout),
                j.off(this._element.closest(Wi), Vi, this._hideModalHandler),
        ...
        _setListeners() {
            ...
            for (const e of t)
                if ("click" === e)
                    ...
                    j.on(this._element, t, this._config.selector, (t) => {
                        ...
                        (e._activeTrigger["focusin" === t.type ? Ki : Ri] = !0),
                            e._enter();
                    }),
                        j.on(this._element, i, this._config.selector, (t) => {
                            const e = this._initializeOnDelegatedTarget(t);
                            (e._activeTrigger["focusout" === t.type ? Ki : Ri] =
            ...
            (this._hideModalHandler = () => {
                ...
                j.on(this._element.closest(Wi), Vi, this._hideModalHandler);
        }
        _fixTitle() {
        ...
        _getConfig(t) {
            ...
            for (const t of Object.keys(e)) zi.has(t) && delete e[t];
            return (
    ...
    const Gi = ".popover-header",
        ...
        ts = { ...Xi.DefaultType, content: "(null|string|element|function)" };
    class es extends Xi {
        static get Default() {
            return Zi;
        }
        ...
        _getContentForTemplate() {
            return { [Gi]: this._getTitle(), [Ji]: this._getContent() };
        }
        _getContent() {
    ...
    const is = ".coreui.scrollspy",
        ...
        as = "[href]",
        ls = ".nav-link",
        cs = `${ls}, .nav-item > ${ls}, .list-group-item`,
        hs = {
            offset: null,
    ...
    class us extends W {
        ...
        _maybeEnableSmoothScroll() {
            this._config.smoothScroll &&
                (j.off(this._config.target, ns),
                j.on(this._config.target, ns, as, (t) => {
        ...
        _initializeTargetsAndObservables() {
            (this._targetLinks = new Map()),
                (this._observableSections = new Map());
            const t = R.find(as, this._config.target);
            for (const e of t) {
        ...
        _process(t) {
            this._activeTarget !== t &&
                ...
                j.trigger(this._element, ss, { relatedTarget: t }));
        }
        _activateParents(t) {
            if (t.classList.contains("dropdown-item"))
                ...
                for (const e of R.parents(t, ".nav, .list-group"))
                    for (const t of R.prev(e, cs)) t.classList.add(rs);
        }
        _clearActiveClass(t) {
            t.classList.remove(rs);
            const e = R.find(`${as}.${rs}`, t);
            for (const t of e) t.classList.remove(rs);
        }
        static jQueryInterface(t) {
            return this.each(function () {
    ...
    class $s extends W {
        ...
        show() {
            j.trigger(this._element, Es),
                ...
                this._overlaid && this._element.classList.add(bs),
                this._isMobile() &&
        ...
        hide() {
            j.trigger(this._element, ws),
                this._element.classList.contains(bs) &&
                    this._element.classList.remove(bs),
                this._isMobile() && (this._backdrop.hide(), new Me().reset()),
                this._isMobile() ||
                    this._overlaid ||
        ...
        narrow() {
            this._isMobile() || (this._addClassName(vs), (this._narrow = !0));
        }
        unfoldable() {
            this._isMobile() ||
                (this._addClassName(ys), (this._unfoldable = !0));
        }
        reset() {
            this._isMobile() ||
                (this._narrow &&
                    (this._element.classList.remove(vs), (this._narrow = !1)),
                this._unfoldable &&
        ...
        _addEventListeners() {
            this._mobile && this._show && this._addClickOutListener(),
                ...
                j.on(this._element, Ts, "[data-coreui-toggle]", (t) => {
                    t.preventDefault();
        ...
        static sidebarInterface(t, e) {
            const i = $s.getOrCreateInstance(t, e);
            if ("string" == typeof e) {
                if (void 0 === i[e])
                    throw new TypeError(`No method named "${e}"`);
                i[e]();
        ...
        static jQueryInterface(t) {
            return this.each(function () {
                $s.sidebarInterface(this, t);
            });
        }
    }
    j.on(window, ks, () => {
        for (const t of Array.from(document.querySelectorAll(Ls)))
            $s.sidebarInterface(t);
    }),
        b($s);
    const Ss = ".coreui.tab",
        Os = `hide${Ss}`,
        ...
        Ys = `.nav-link${Qs}, .list-group-item${Qs}, [role="tab"]${Qs}, ${Us}`,
        Xs = `.${Ws}[data-coreui-toggle="tab"], .${Ws}[data-coreui-toggle="pill"], .${Ws}[data-coreui-toggle="list"]`;
    class Gs extends W {
        constructor(t) {
            super(t),
                ...
                this._parent &&
                    ...
                    j.on(this._element, Ms, (t) => this._keydown(t)));
        }
        static get NAME() {
            return "tab";
        }
        show() {
            ...
            const e = this._getActiveElem(),
                i = e ? j.trigger(e, Os, { relatedTarget: t }) : null;
                    ...
                    () => {
                        "tab" === t.getAttribute("role")
                            ? (t.removeAttribute("tabindex"),
                              ...
                              j.trigger(t, Ds, { relatedTarget: e }))
                            : t.classList.add(Rs);
                    },
                    t,
        ...
        _keydown(t) {
            if (![js, Fs, zs, Hs, qs, Bs].includes(t.key)) return;
            t.stopPropagation(), t.preventDefault();
            const e = this._getChildren().filter((t) => !d(t));
            let i;
            if ([qs, Bs].includes(t.key))
                i = e[t.key === qs ? 0 : e.length - 1];
            else {
                const s = [Fs, Hs].includes(t.key);
                i = w(e, t.target, s, !0);
            }
            i &&
        ...
        _getInnerElement(t) {
            return t.matches(Ys) ? t : R.findOne(Ys, t);
        }
        _getOuterElement(t) {
    ...
    j.on(document, xs, Us, function (t) {
        ["A", "AREA"].includes(this.tagName) && t.preventDefault(),
            d(this) || Gs.getOrCreateInstance(this).show();
    }),
        j.on(window, Ps, () => {
            for (const t of R.find(Xs)) Gs.getOrCreateInstance(t);
        }),
        b(Gs);
    const Js = ".coreui.toast",
        Zs = `mouseover${Js}`,
        tn = `mouseout${Js}`,
        en = `focusin${Js}`,
        sn = `focusout${Js}`,
    ...
    class _n extends W {
        ...
        show() {
            j.trigger(this._element, rn).defaultPrevented ||
                (this._clearTimeout(),
                this._config.animation && this._element.classList.add("fade"),
                this._element.classList.remove(ln),
                g(this._element),
                this._element.classList.add(cn, hn),
                this._queueCallback(
                    () => {
                        this._element.classList.remove(hn),
                            j.trigger(this._element, an),
        ...
        hide() {
            this.isShown() &&
                (j.trigger(this._element, nn).defaultPrevented ||
                    (this._element.classList.add(hn),
                    this._queueCallback(
                        () => {
                            this._element.classList.add(ln),
                                this._element.classList.remove(hn, cn),
        ...
        _setListeners() {
            j.on(this._element, Zs, (t) => this._onInteraction(t, !0)),
                j.on(this._element, tn, (t) => this._onInteraction(t, !1)),
                j.on(this._element, en, (t) => this._onInteraction(t, !0)),
                j.on(this._element, sn, (t) => this._onInteraction(t, !1));
        }
        _clearTimeout() {
